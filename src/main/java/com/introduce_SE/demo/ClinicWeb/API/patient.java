...
//	public Prescription addMedicine(@PathVariable String id, @RequestBody int idMedicine, @RequestBody int quantity) {
//		Prescription p = new Prescription();
//		prescriptionId pid = new prescriptionId(id, idMedicine);
//		p.setId(pid);
